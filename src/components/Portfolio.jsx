    ...
    return (
        <section className="portfolio py-5" id="portfolio">
            <div className="text-center p-1">
                <p className="text-theme m-0"><small>Portfolio</small></p>
                <h2><span className="text-theme">O</span>ur <span className="text-theme">P</span>ortfolio</h2>
            ...
            <div className="container">
                ...
                <div className="text-center mt-3">
                    <button className="btn btn-primary" onClick={seeMoreHandle}>See More</button>
                </div>
